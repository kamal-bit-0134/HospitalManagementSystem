...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="img/6.jpg" class="d-block w-100" alt="..."height="500px">
    </div>
    <div class="carousel-item">
      <img src="img/8.jpg" class="d-block w-100" alt="..."height="500px">
    </div>
...
<div class="container p-2">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/13.jpg" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/15.jpg" width="250px" height="300px">
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						<img src="img/11.jpg" width="250px" height="300px">
